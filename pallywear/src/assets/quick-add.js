if (!customElements.get('quick-add-modal')) {
    customElements.define('quick-add-modal', class QuickAddModal extends ModalDialog {
        ...
        show(opener) {
            ...
            opener.querySelector('.loading-overlay-spinner').classList.remove('hidden');
            ...
            fetch(opener.getAttribute('data-product-url'))
                ...
                .then((responseText) => {
                    ...
                    removeElementsByScreenSize(this.modalContent);
                ...
                .finally(() => {
                    ...
                    opener.querySelector('.loading-overlay-spinner').classList.add('hidden');
                });
