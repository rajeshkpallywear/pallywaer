    ...
    customElements.define(
        ...
        class QuantityPopover extends HTMLElement {
            constructor() {
                ...
                if (this.closeButton) this.closeButton.addEventListener('click', this.closePopover.bind(this));
            ...
            togglePopover(event) {
                ...
                if (event.type === 'mouseenter') this.eventMouseEnterHappened = true;
                ...
                if (button.getAttribute('aria-expanded') === 'true' && event.type !== 'mouseenter') button.focus();
            }
